...
class Venue(db.Model):
    ...
    artists = db.relationship('Artist', secondary='show', backref='venue', lazy=True)

    def __repr__(self):
        return f'<Venue {self.id}, {self.name} {self.artists}>'
...
class Artist(db.Model):
    ...
    seeking_description = db.Column(db.String(), nullable=True)
    genres = db.Column(db.ARRAY(db.String()), nullable=True)
    genres = db.relationship('Genre', backref='')
